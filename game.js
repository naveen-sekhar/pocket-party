...
const WORD_DATABASE = {
    ...
    cartoons: {
        ...
        pairs: [
            ...
            { civilian: "Bugs Bunny", undercover: "Daffy Duck" },
            { civilian: "SpongeBob", undercover: "Patrick" },
            { civilian: "Scooby-Doo", undercover: "Scrappy-Doo" },
            { civilian: "Dexter", undercover: "Dee Dee" },
            { civilian: "Johnny Bravo", undercover: "Samurai Jack" },
            { civilian: "The Powerpuff Girls", undercover: "The Rowdyruff Boys" },
            { civilian: "Ben 10", undercover: "Generator Rex" },
            { civilian: "Finn", undercover: "Jake" },
            { civilian: "Mordecai", undercover: "Rigby" },
            { civilian: "Gumball", undercover: "Darwin" },
            { civilian: "Popeye", undercover: "Bluto" },
            { civilian: "Fred Flintstone", undercover: "George Jetson" },
            { civilian: "Woody Woodpecker", undercover: "Road Runner" },
            { civilian: "Pink Panther", undercover: "Inspector Clouseau" },
            { civilian: "Garfield", undercover: "Heathcliff" },
            { civilian: "Dennis the Menace", undercover: "Calvin" },
            { civilian: "Bart Simpson", undercover: "Eric Cartman" },
            { civilian: "Homer Simpson", undercover: "Peter Griffin" },
            { civilian: "Stewie Griffin", undercover: "Brian Griffin" },
            { civilian: "Shaggy", undercover: "Scooby" },
            { civilian: "Velma", undercover: "Daphne" },
            { civilian: "Courage the Cowardly Dog", undercover: "Eustace Bagge" },
            { civilian: "Ed", undercover: "Edd" },
            { civilian: "Buttercup", undercover: "Blossom" },
            { civilian: "Bubbles", undercover: "Buttercup" },
            { civilian: "Dora the Explorer", undercover: "Diego" },
            { civilian: "Phineas", undercover: "Ferb" },
            { civilian: "Perry the Platypus", undercover: "Dr. Doofenshmirtz" },
            { civilian: "Timmy Turner", undercover: "Jimmy Neutron" },
            { civilian: "Cosmo", undercover: "Wanda" },
            { civilian: "Danny Phantom", undercover: "Jake Long" },
            { civilian: "Kim Possible", undercover: "Ron Stoppable" },
            { civilian: "Aang", undercover: "Korra" },
            { civilian: "Zuko", undercover: "Azula" },
            { civilian: "Sokka", undercover: "Katara" },
            { civilian: "Toph", undercover: "Bumi" },
            { civilian: "Robin", undercover: "Beast Boy" },
            { civilian: "Raven", undercover: "Starfire" },
            { civilian: "Cyborg", undercover: "Robin" },
            { civilian: "Oggy", undercover: "Jack" },
            { civilian: "Winnie the Pooh", undercover: "Paddington Bear" },
            { civilian: "Tigger", undercover: "Piglet" },
            { civilian: "Elmer Fudd", undercover: "Yosemite Sam" },
            { civilian: "Tweety", undercover: "Sylvester" },
            { civilian: "Tasmanian Devil", undercover: "Wile E. Coyote" },
            { civilian: "Peppa Pig", undercover: "George Pig" },
            { civilian: "Chhota Bheem", undercover: "Mighty Raju" },
            { civilian: "Shinchan", undercover: "Doraemon" },
            { civilian: "Nobita", undercover: "Shinchan" },
            { civilian: "Pikachu", undercover: "Charizard" },
            { civilian: "Ash Ketchum", undercover: "Goku" },
            ...
            { civilian: "Woody", undercover: "Buzz Lightyear" },
            { civilian: "Shrek", undercover: "Donkey" },
            { civilian: "Lightning McQueen", undercover: "Mater" },
            { civilian: "Nemo", undercover: "Dory" },
            { civilian: "Wall-E", undercover: "EVE" },
            { civilian: "Ratatouille", undercover: "Linguini" },
            { civilian: "Rapunzel", undercover: "Moana" },
            { civilian: "Stitch", undercover: "Lilo" },
            { civilian: "Bambi", undercover: "Dumbo" },
            { civilian: "Peter Pan", undercover: "Captain Hook" },
            { civilian: "Aladdin", undercover: "Genie" },
            { civilian: "Mowgli", undercover: "Baloo" },
            { civilian: "Tarzan", undercover: "Mowgli" },
            { civilian: "Cinderella", undercover: "Snow White" },
            { civilian: "Belle", undercover: "Ariel" },
            { civilian: "Jasmine", undercover: "Pocahontas" },
            { civilian: "Mulan", undercover: "Merida" },
            { civilian: "Jack Skellington", undercover: "Oogie Boogie" },
            { civilian: "Sulley", undercover: "Mike Wazowski" },
            { civilian: "Mr. Incredible", undercover: "Elastigirl" },
            { civilian: "Dash", undercover: "Violet" },
            { civilian: "Hiro Hamada", undercover: "Baymax" },
            { civilian: "Ralph", undercover: "Vanellope" },
            { civilian: "Judy Hopps", undercover: "Nick Wilde" },
            { civilian: "Po", undercover: "Tigress" },
            { civilian: "Hiccup", undercover: "Toothless" },
            { civilian: "Skipper", undercover: "King Julien" },
            { civilian: "Oggy", undercover: "Cockroaches" },
            { civilian: "Mr. Bean", undercover: "Teddy" },
            { civilian: "Inspector Gadget", undercover: "Penny" },
            { civilian: "ThunderCats", undercover: "He-Man" },
            { civilian: "Optimus Prime", undercover: "Bumblebee" },
            { civilian: "Megatron", undercover: "Starscream" },
            { civilian: "Voltron", undercover: "Power Rangers" },
            { civilian: "Captain Planet", undercover: "The Planeteers" },
            { civilian: "Swat Kats", undercover: "Biker Mice" },
            { civilian: "Teenage Mutant Ninja Turtles", undercover: "Power Rangers" },
            { civilian: "Leonardo", undercover: "Raphael" },
            { civilian: "Michelangelo", undercover: "Donatello" },
            { civilian: "Jem", undercover: "Barbie" },
            { civilian: "He-Man", undercover: "She-Ra" },
            { civilian: "Chilly Willy", undercover: "Pingu" }
        ]
    }
};
